workspace {
    model {
        ...
        greekGodSystem = softwareSystem "Greek Good REST System based on Spring Boot framework" {
            ...
            springboot = container "greek-good-service" {
                ...
                schedulerService = component "My JSON Server Synchronizer Service" "This service interact with the third party service: https://my-json-server.typicode.com/jabrena/latency-problems/greek and store the information in the internal database. The process is executed every 10 seconds"
    ...
    views {
        ...
        deploymentView "Gateway Flow" {
            title "Gateway to Spring Boot Flow"
            include appGateway vnet.appService.webapp
        ...
        styles {
            ...
            element "Azure - Application Gateway" {
                ...
                color #ffffff
                shape RoundedBox
                icon "https://raw.githubusercontent.com/azure-icons/azure-icons/main/svg/networking/Application-Gateways.svg"
                strokeWidth 2
                fontSize 14
            }
        }
